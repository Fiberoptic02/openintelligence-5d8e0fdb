...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Portfolio — AI Automation & Business Intelligence Engineer" },
      { name: "description", content: "Control systems engineer turned data & AI automation specialist. Building intelligent pipelines that turn operational data into business intelligence." },
      { property: "og:title", content: "Portfolio — AI Automation & Business Intelligence Engineer" },
